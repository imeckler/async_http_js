(* OASIS_START *)
(* DO NOT EDIT (digest: 4b5b7e141fdadf75937dbaa812200556) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          copyrights =
            ["(C) 2016 Jane Street Group LLC <opensource@janestreet.com>"];
          maintainers =
            ["Jane Street Group"; "LLC <opensource@janestreet.com>"];
          authors = ["Jane Street Group"; "LLC <opensource@janestreet.com>"];
          homepage = Some "https://github.com/imeckler/async_http_js";
          bugreports = None;
          synopsis =
            "A small library to perform http requests using Async_kernel on JavaScript platforms.";
          description = None;
          tags = [];
          categories = [];
          files_ab = ["META.ab"];
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage ("async_kernel", None);
                           FindlibPackage ("js_of_ocaml", None);
                           FindlibPackage ("sexplib\njs_of_ocaml.ppx", None)
                        ];
                      bs_build_tools =
     ...
     oasis_version = "0.4.7";
     oasis_digest = Some "\025\tF\006*\210\159\136\135N\192\tSu\148y";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
